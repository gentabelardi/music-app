            ...
            <div className="relative flex-auto  bg-gradient-to-b from-green-700">
                <div ref={scroller} className="flex flex-col  h-screen  overflow-y-auto">
                    <div className=" w-full">
                        ...
                        <div className="flex p-5 w-full  pt-32 pb-12 space-x-5 ">
                            <div className="relative group">
                                <img src="/cover/dummy2.jpg" className="shadow-2xl rounded-full   h-[200px] h-[200px] object-cover " alt="" />
                                <button className="flex visible hidden group-hover:block absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hover:bg-white/5 p-2  rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="42" height="42"><path fill="none" d="M0 0h24v24H0z" /><path d="M9.243 19H21v2H3v-4.243l9.9-9.9 4.242 4.244L9.242 19zm5.07-13.556l2.122-2.122a1 1 0 0 1 1.414 0l2.829 2.829a1 1 0 0 1 0 1.414l-2.122 2.121-4.242-4.242z" fill="rgba(255,255,255,1)" /></svg>                                </button>
                            </div>
                            <div className="flex   flex-col ">
                                <span className="text-white mb-2 uppercase text-xs">Profile</span>
                                <h1 className="text-white font-bold text-7xl">Michel</h1>
                                <div className="flex mt-5">
                                    <motion.button whileTap={{ scale: 1.2 }} className="bg-white/5 capitalized hover:bg-white/10 border border-white/20 p-1 px-5 text-white  rounded-full">
                                        Edit Profile
                                    </motion.button>
                                </div>
                            </div>
                    ...
                    <div className="flex my-2 pb-32 flex-col   backdrop-blur-sm bg-gradient-to-t from-[#151515] via-[#151515]">
                        <div className="flex p-3 px-5 items-center justify-between">
                            <div >
                                <h1 className="text-white font-bold mr-2 text-xl">Top track this month</h1>
                                <span className="text-white/50 font-medium text-sm">Only visible to you</span>
                            </div>
                            <a href="#" className=" text-white font-regular text-xs uppercase">see all</a>
